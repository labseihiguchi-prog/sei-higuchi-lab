...
const labEventsUnsorted: LabEvent[] = [
  {
    ...
    shortDescription: "The Higuchi Lab came together for a very special celebration honoring Afsin’s birthday, welcoming her daughter Amelie to our lab family, and congratulating Afsin on her promotion to Doctoral Fellow. Over food, cake, and plenty of smiles, we also officially unveiled the new Sei Higuchi Lab website — making September 16 the birthday of our lab’s digital home.",
    ...
    sections: [{
      ...
      description: "Moments from a special day together, celebrating Afsin and sharing the occasion with our lab family.",
